...
import type { IEstimate } from '../api/get';

export const EstimateRowItem = ({ row, remove, edit }: RowItemProps<IEstimate>) => {
  ...
  return (
    <TableRow hover>
      ...
      <TableCell>{row.year_total?.toLocaleString() || '-'}</TableCell>
